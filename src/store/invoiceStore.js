...
const loadInvoicesFromLocalStorage = () => {
  const storedInvoices = localStorage.getItem("invoicesData");
...
const invoicesData = loadInvoicesFromLocalStorage();
...
export const useInvoiceStore = create((set) => ({
  ...
  addInvoice: (newInvoice) =>
    set((state) => {
      const updatedInvoices = [...state.invoicesData, newInvoice];
      saveInvoicesToLocalStorage(updatedInvoices);
      return { invoicesData: updatedInvoices };
    }),

  updateInvoice: (updatedInvoice) =>
    set((state) => {
      const updatedInvoices = state.invoicesData.map((invoice) =>
  ...
  deleteInvoice: (invoiceId) =>
    set((state) => {
      const updatedInvoices = state.invoicesData.filter(
